...
#(
  ...
  //logic rf_bignum_mulv_en_d, rf_bignum_mulv_en_q;
  //assign rf_bignum_mulv_en_d = rf_bignum_mulv_en_i;

  
  assign rf_predec_bignum_o        = rf_bignum_mulv_en_i ? rf_predec_bignum_mulv : rf_predec_bignum_q; //ToDo: Predecoding for MULV should be implemented differently
