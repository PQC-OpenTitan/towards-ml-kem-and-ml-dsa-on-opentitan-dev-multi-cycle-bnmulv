...
hw/ip/otbn/util/otbn_as.py -DKYBER_K=2 -o $TMPDIR/kyber512_mlkem_enc_test.o sw/otbn/crypto/tests/kyber512_mlkem_enc_test.s
...
hw/ip/otbn/util/otbn_ld.py -o $TMPDIR/kyber512_mklem_enc_test.elf $TMPDIR/kyber512_mlkem_enc_test.o $TMPDIR/kyber_packing.o $TMPDIR/kyber_poly_gen_matrix.o $TMPDIR/kyber_poly.o $TMPDIR/kyber_cbd_isaext.o $TMPDIR/kyber_basemul.o $TMPDIR/kyber_ntt.o $TMPDIR/kyber_intt.o $TMPDIR/kyber_mlkem.o

# Run the test
./hw/ip/otbn/util/otbn_sim_test.py -v hw/ip/otbn/dv/otbnsim/standalone.py sw/otbn/crypto/tests/kyber512_mlkem_enc_test.exp $TMPDIR/kyber512_mklem_enc_test.elf
